...
Разработан на Unity 6.              [Демо](https://icamysss.github.io/kwork_SolarPanel/) | [Документация](https://github.com/icamysss/SolarPanel-Kwork/tree/main/Technical%20specification)
...
- **Расчёт мощности солнечных батарей**:
  ...
  - Фомирование отчета в формате *.xlsx
- **3D-визуализация**:
